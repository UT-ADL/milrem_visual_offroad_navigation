...
class WaypointVAEExperiment(BaseExperiment):

    def __init__(self, vae_model: WaypointVAEGNM, alpha: float, kld_weight: float,
                 learning_rate: float, num_images_log: int,
                 normalize: bool, project_folder: str, scheduler_gamma: float) -> None:
        super(WaypointVAEExperiment, self).__init__(project_folder, num_images_log, normalize)
